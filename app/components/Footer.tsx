...
const Footer = () => {
    return (
        <footer className="bg-black text-white pt-14 pb-3">
            <div className="flex justify-between flex-col md:flex-row gap-[50px] md:gap-0 max-w-screen-xl mx-auto px-5">
                {/* LEFT START */}
                <div className="flex gap-[50px] md:gap-[75px] lg:gap-[100px] flex-col md:flex-row">
                    {/* MENU START */}
                    <div className="flex flex-col gap-3 shrink-0">
                        <div className="font-semibold uppercase text-sm cursor-pointer">
                            Find a store
                        </div>
                        <div className="font-semibold uppercase text-sm cursor-pointer">
                            become a partner
